...
open class DOAlertAnimation : NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func presentAnimateTransition(_ transitionContext: UIViewControllerContextTransitioning) {
        ...
        if (alertController.isAlert()) {
            ...
            alertController.alertView.layer.cornerRadius = 10
        } else {
...
open class DOAlertController : UIViewController, UITextFieldDelegate, UIViewControllerTransitioningDelegate {
    ...
    open var messageFont = UIFont(name: "Roboto-Medium", size: 16)
    ...
    open var buttonFont: [DOAlertActionStyle : UIFont] = [
        .default : UIFont(name: "Roboto-Bold", size: 16) ?? UIFont.systemFont(ofSize: 16),
        .cancel  : UIFont(name: "Roboto-Bold", size: 16) ?? UIFont.systemFont(ofSize: 16),
        .destructive  : UIFont(name: "Roboto-Bold", size: 16) ?? UIFont.systemFont(ofSize: 16)
    ]
    ...
    open var buttonBgColor: [DOAlertActionStyle : UIColor] = [
        .default : #colorLiteral(red: 0.9176470637, green: 0.5686274767, blue: 0.1882352978, alpha: 1),
        .cancel  : #colorLiteral(red: 0.9176470637, green: 0.5686274767, blue: 0.1882352978, alpha: 1),
        .destructive  : #colorLiteral(red: 0.9176470637, green: 0.5686274767, blue: 0.1882352978, alpha: 1)
    ]
    ...
    fileprivate var buttonCornerRadius: CGFloat = 20
...
//        NotificationCenter.default.addObserver(self, selector: #selector(DOAlertController.handleKeyboardWillHideNotification(_:)), name: NSNotification.Name.UIResponder.keyboardWillHideNotification, object: nil)
//        
        // Delegate
